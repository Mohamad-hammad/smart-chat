            ...
            <div className="bg-gradient-to-r from-[#6566F1]/10 via-[#7B68EE]/10 to-[#9370DB]/10 border-b border-gray-200/50 p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Chat with your assigned bot to test its responses</p>
                </div>
              </div>
            </div>
              ...
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-gray-600 max-w-md leading-relaxed">
                    Start a conversation with your assigned bot to test its responses and see how it handles different queries.
                  </p>
