        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ...
              Engage visitors, answer questions, and convert leads 24/7.
            </p>
            <div className="flex space-x-4">
              {/* Email */}
              <a href="mailto:contact@chatbotpro.com" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} ChatBot Pro. All rights reserved.
            </p>
            <div className="flex items-center space-x-6">
              <span className="text-gray-400 text-sm">Made with ❤️ for better customer experiences</span>
            </div>
          </div>
        </div>
      </div>
